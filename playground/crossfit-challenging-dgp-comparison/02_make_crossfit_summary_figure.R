...
#
# Build a compact figure comparing the original CP + Cox method against the
# cross-fitted variant under the harder-DGP experiment.
...
parse_cli <- function(args) {
  cfg <- list(
    results_dir = "playground/crossfit-challenging-dgp-comparison/results/matched-v1",
